import { getYearsExperiencePlus } from "./company";
...
export const schemaPerson = {
  ...
  "url": SITE_URL + "/about/",
  "description": `Founder and CEO of SDF Clothing, Bangladeshi entrepreneur with ${getYearsExperiencePlus()} years in garment manufacturing. Industrialist, philanthropist, and disability rights advocate.`,
